...
#define R2R_PACKAGE_VERSION "1.0.6"
...
void GscWeightCommand(int argc,char *argv[],int a,int topNMostConserved,bool usePositionBasedWeighting,double maxNonCanonInNoVariationObserved,const char *rnieEmblcsvFileName,const char *rnieOutStoFileName,bool verbose)
{
...
int try_main(int argc, char* argv[])
{
    ...
    if (strcmp(argv[a],"--GSC-weighted-consensus")==0) {
		GscWeightCommand(argc,argv,a,topNMostConserved,usePositionBasedWeighting,maxNonCanonInNoVariationObserved,rnieEmblcsvFileName,rnieOutStoFileName,verbose);
      return 0;
    }
